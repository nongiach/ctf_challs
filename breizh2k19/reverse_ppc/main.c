...
int main() {
 // apt install gcc-8-powerpc64-linux-gnu
 // powerpc64-linux-gnu-gcc-8 main.c -o sh
	ranctx state;
	...
	/* unsigned char flag[] = "ThisIsTheFuckingFlag"; */
	/* unsigned char flag[] = {219,135,32,124,200,124,219,135,62,142,118,69,74,32,149,37,142,44,157,37, 0}; */
	/* unsigned char flag[] = {221,227,173,160,219,142,134,0}; // "Br{CTF}" */
	unsigned char flag[] = {221,23,138,200,119,117,160,219,142,173,160,62,118,203,144,34,118,32,144,118,225,32,44,32,124,62,149,225,144,157,227,12,144,149,170,175,144,37,157,37,149,62,149,225,144,166,118,144,225,62,12,78,124,134,0};
	unsigned char input[256];
	write(1, "Password: ", 10);
	int read_ret = read(0, input, 256);
	input[read_ret - 1] = 0;
	do_transpose(input, transpose);
